    ...
    <div data-role="main" class="ui-content">
        ...
        <div data-role="main" class="ui-content">
            ...
            <form id="BrowseForm" runat="server">
                <asp:ScriptManager ID="NotesScriptManager" runat="server"></asp:ScriptManager>
                <asp:UpdatePanel ID="NotesUpdatePanel" runat="server" ValidateRequestMode="Inherit">
                    <ContentTemplate>               
                         <asp:Timer ID="NotesTimer" runat="server" Interval="3600" OnTick="NotesTimer_Tick"></asp:Timer>
                        <asp:GridView ID="NotesGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="GridViewDataSource" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" onselectedindexchanged="NotesGridView_SelectedIndexChanged" DataKeyNames="Title" AllowSorting="True">
