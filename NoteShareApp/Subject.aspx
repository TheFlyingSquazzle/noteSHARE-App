...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
         ...
         <div data-role="main" class="ui-content">
            ...
            <form id="UploadForm" data-ajax="False" runat="server">
                ...
                <br />
                <br />
                <asp:Button ID="NextButton" runat="server" Text="Next" ForeColor="#7CCBF2" Font-Size="20pt" BorderStyle="None" BackColor="White" Width="100%" UseSubmitBehavior="True" Font-Bold="True" OnClick="NextButton_Click" />
